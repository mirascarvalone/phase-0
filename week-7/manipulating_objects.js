...
//  Tests 8, 9, and 10 were the most difficult (adding the children). Initially I was trying to define them as var carson = etc. but that wasn't correct. It wasn't until I re-read the instructions and saw that we were supposed to define the children as properties that I figured out I should write carson: {}, etc.
// How difficult was it to add and delete properties outside of the object itself?
//  I had to look up how to delete things (just add a delete word in front), but then it was pretty easy.
// What did you learn about manipulating objects in this challenge?
//  It was good to get hands on practice manipulating objects outside of their initial defintion (as we did with Terah).
